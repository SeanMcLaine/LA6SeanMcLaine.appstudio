...
const cacheName = 'LA6SeanMcLaine-2021-09-29 23:09:04.746788'; // unique value, generated each deploy
  ...
  e.waitUntil(
    caches.keys().then((keyList) => {
      ...
      return Promise.all(keyList.map((key) => {
        ...
        if (cacheName.indexOf(key) === -1  && key.substr(0, 'LA6SeanMcLaine'.length) === 'LA6SeanMcLaine') {
